...
ggplot() + 
  geom_point(data = plot_dataMQNP2, aes(x=sample_num,y=total_proteins, colour = "MQ Non-PNGase F")) +
  geom_point(data = plot_dataMQP2, aes(x=sample_num,y=total_proteins, colour = "MQ PNGase F")) + 
  geom_point(data = plot_dataTPPNP2, aes(x=sample_num,y=total_proteins, colour = "TPP Non-PNGase F")) +
  geom_point(data = plot_dataTPPP2, aes(x=sample_num,y=total_proteins, colour = "TPP PNGase F")) + 
